...
public class PrintStreamOutputVersionStreamVerifierListenerTest {
	...
	public void testOnMissingInPrimaryStream() throws Exception {
		final PrintStreamOutputVersionStreamVerifierListener streamVerifierListener = new PrintStreamOutputVersionStreamVerifierListener(printStream);
	...
	public void testVersionIsFormattedForMismatch() {
		...
		final PrintStreamOutputVersionStreamVerifierListener streamVerifierListener = new PrintStreamOutputVersionStreamVerifierListener(printStream, versionFormatter);
		streamVerifierListener.onVersionMisMatch(idAndVersion, new StringIdAndVersion("1", 9));
		verify(printStream)
				.println("MISMATCH\t1\t9 Bottles of Beer on the Wall\tsecondaryVersion=9 Bottles of Beer on the Wall");
	}
